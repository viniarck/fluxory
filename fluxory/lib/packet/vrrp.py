...
from fluxory.lib.packet import ether_types as ether
from fluxory.lib.packet import in_proto as inet
from fluxory.lib.packet import ipv4
from fluxory.lib.packet import ipv6
from fluxory.lib.packet import packet
from fluxory.lib.packet import packet_base
from fluxory.lib.packet import packet_utils
from fluxory.lib.packet import vlan
...
class vrrp(packet_base.PacketBase):
    ...
    Unlike other fluxory.lib.packet.packet_base.PacketBase derived classes,
    ...
    def create_packet(self, primary_ip_address, vlan_id=None):
        ...
        Returns a newly created fluxory.lib.packet.packet.Packet object
...
class vrrpv2(vrrp):
    ...
    *create* method should be used to instantiate an object of this class.
    ...
    def create(type_, vrid, priority, max_adver_int, ip_addresses):
        ...
        This method's arguments are same as fluxory.lib.packet.vrrp.vrrp object's
