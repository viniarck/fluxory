...
from fluxory.lib.stringify import StringifyMixin
from fluxory.lib.packet import afi as addr_family
from fluxory.lib.packet import safi as subaddr_family
from fluxory.lib.packet import packet_base
from fluxory.lib.packet import stream_parser
from fluxory.lib.packet import vxlan
from fluxory.lib.packet import mpls
from fluxory.lib import addrconv
from fluxory.lib import type_desc
from fluxory.lib.type_desc import TypeDisp
from fluxory.lib import ip
from fluxory.lib.pack_utils import msg_pack_into
from fluxory.utils import binary_str
from fluxory.utils import import_module
...
class FlowSpecVPNv4NLRI(_FlowSpecNLRIBase):
    ...
    def from_user(cls, route_dist, **kwargs):
        ...
        :param kwargs: See :py:mod:`fluxory.lib.packet.bgp.FlowSpecIPv4NLRI`
...
class FlowSpecVPNv6NLRI(_FlowSpecNLRIBase):
    ...
    def from_user(cls, route_dist, **kwargs):
        ...
        :param route_dist: Route Distinguisher.
        :param kwargs: See :py:mod:`fluxory.lib.packet.bgp.FlowSpecIPv6NLRI`
        """
        return cls._from_user(route_dist, **kwargs)
...
class StreamParser(stream_parser.StreamParser):
    ...
    This is a subclass of fluxory.lib.packet.stream_parser.StreamParser.
