...
class icmp(packet_base.PacketBase):
    ...
    data           Payload. \
                   ...
                   fluxory.lib.packet.icmp.echo or \
                   fluxory.lib.packet.icmp.dest_unreach or \
                   fluxory.lib.packet.icmp.TimeExceeded object \
                   NOTE for icmp.echo: \
...
class echo(_ICMPv4Payload):
    ...
    This is used with fluxory.lib.packet.icmp.icmp for
