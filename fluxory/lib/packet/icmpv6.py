...
class icmpv6(packet_base.PacketBase):
    ...
    data           Payload.
                   ...
                   fluxory.lib.packet.icmpv6.echo object, \
                   fluxory.lib.packet.icmpv6.nd_neighbor object, \
                   fluxory.lib.packet.icmpv6.nd_router_solicit object, \
                   fluxory.lib.packet.icmpv6.nd_router_advert object, \
                   fluxory.lib.packet.icmpv6.mld object, \
                   or a bytearray.
    ============== ====================
    """
    _PACK_STR = '!BBH'
...
class nd_neighbor(_ICMPv6Payload):
    ...
    This is used with fluxory.lib.packet.icmpv6.icmpv6.
    ...
    dst            Target Address
    option         a derived object of fluxory.lib.packet.icmpv6.nd_option \
...
class nd_router_advert(_ICMPv6Payload):
    ...
    options        List of a derived object of \
                   fluxory.lib.packet.icmpv6.nd_option or a bytearray. \
                   None if no options.
    ============== ====================
    """
...
class nd_option_sla(nd_option_la):
    ...
    This is used with fluxory.lib.packet.icmpv6.nd_neighbor,
    fluxory.lib.packet.icmpv6.nd_router_solicit or
    fluxory.lib.packet.icmpv6.nd_router_advert.
...
class nd_option_pi(nd_option):
    ...
    This is used with fluxory.lib.packet.icmpv6.nd_router_advert.
...
class echo(_ICMPv6Payload):
    ...
    This is used with fluxory.lib.packet.icmpv6.icmpv6 for
...
class mldv2_report(mld):
    ...
    records        a list of fluxory.lib.packet.icmpv6.mldv2_report_group.
                   None if no records.
    ============== =========================================
    """
...
class mldv2_report_group(stringify.StringifyMixin):
    ...
    This is used with fluxory.lib.packet.icmpv6.mldv2_report.
