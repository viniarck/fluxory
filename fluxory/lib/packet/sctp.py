...
class sctp(packet_base.PacketBase):
    ...
    chunks         a list of derived classes of fluxory.lib.packet.sctp.chunk.
    ============== =====================================================
    """
...
class chunk_init(chunk_init_base):
    ...
    params         Optional/Variable-Length Parameters.
                   ...
                   a list of derived classes of fluxory.lib.packet.sctp.param.
    ============== =====================================================
    """
...
class chunk_heartbeat(chunk_heartbeat_base):
    ...
    length         length of this chunk containing this header.
                   (0 means automatically-calculate when encoding)
    info           fluxory.lib.packet.sctp.param_heartbeat.
    ============== =====================================================
    """
...
class chunk_abort(chunk):
    ...
    length         length of this chunk containing this header.
                   (0 means automatically-calculate when encoding)
    causes         a list of derived classes of fluxory.lib.packet.sctp.causes.
    ============== =====================================================
    """
...
class cause_invalid_stream_id(cause_with_value):
    ...
    - fluxory.lib.packet.sctp.chunk_abort
    - fluxory.lib.packet.sctp.chunk_error
...
class cause_unresolvable_addr(cause_with_value):
    ...
    value          Unresolvable Address. one of follows:
                   ...
                   fluxory.lib.packet.sctp.param_host_addr,

                   fluxory.lib.packet.sctp.param_ipv4, or

                   fluxory.lib.packet.sctp.param_ipv6.
    length         length of this cause containing this header.
                   (0 means automatically-calculate when encoding)
    ============== =====================================================
    """
...
class param_heartbeat(param):
    ...
    - fluxory.lib.packet.sctp.chunk_heartbeat
    - fluxory.lib.packet.sctp.chunk_heartbeat_ack
...
class param_state_cookie(param):
    ...
    - fluxory.lib.packet.sctp.chunk_init_ack
...
class param_cookie_preserve(param):
    ...
    - fluxory.lib.packet.sctp.chunk_init
