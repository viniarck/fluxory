...
from fluxory.ofproto.ofproto_parser import StringifyMixin, MsgBase
...
from fluxory.ofproto import ofproto_v1_3 as ofproto
...
import logging
LOG = logging.getLogger('fluxory.ofproto.ofproto_v1_3_parser')


def _register_exp_type(experimenter: int, exp_type: int) -> Callable:
...
class OFPHello(MsgBase):
    ...
    def __init__(self, elements=None):
        ...
        super(OFPHello, self).__init__(OFPHello.version, OFPHello.msg_type)
...
class OFPEchoRequest(MsgBase):
    ...
    def __init__(self, data=None):
        super(OFPEchoRequest, self).__init__(ofproto.OFP_VERSION,
                                             OFPEchoRequest.msg_type)
        self.data = data
...
class OFPExperimenter(MsgBase):
    ...
    @classmethod
    def parser(cls, msg_len: int, xid: int, buf: bytes) -> Callable:
        msg = super(OFPExperimenter, cls).parser(msg_len,
                                                 xid, buf)
...
class OFPSwitchFeatures(MsgBase):
    ...
    def __init__(self, datapath_id=None, n_buffers=None,
...
class OFPMatch(StringifyMixin):
    ...
    def __init__(self, type_: None = None, length: None = None, _ordered_fields: None = None,
                 **kwargs) -> None:
        """
        You can define the flow match by the keyword arguments.
    ...
    def parser(cls, buf, offset):
        ...
        if exc is not None:
            raise exceptions.OFPTruncatedMessage(match, residue, exc)
        return match
...
class OFPMatchField(StringifyMixin):
    ...
    @staticmethod
    def register_field_header(headers: List[int]) -> Callable:
...
class OFPFlowRemoved(MsgBase):
    ...
    def __init__(self, cookie=None, priority=None, reason=None,
...
class OFPPacketOut(MsgBase):
    ...
    def __init__(self, buffer_id=None, in_port=None, actions=None,
...
class OFPFlowMod(MsgBase):
    ...
    def parser(cls, msg_len: int, xid: int, buf: bytes) -> Callable:
        ...
        try:
            ...
            msg.instructions = instructions
            raise exceptions.OFPTruncatedMessage(ofpmsg=msg,
                                                residue=buf[offset:],
...
class OFPInstructionActions(OFPInstruction):
    ...
    def parser(cls, buf, offset):
        ...
        inst.len = len_
        if exc is not None:
            raise exceptions.OFPTruncatedMessage(ofpmsg=inst,
                                                residue=buf[offset:],
...
class OFPTableMod(MsgBase):
    ...
    def __init__(self, table_id, config):
...
class OFPMeterConfigStatsRequest(OFPMultipartRequest):
    ...
    Example::
        ...
        def send_meter_config_stats_request(self):
            ofp = datapath.ofproto
            ofp_parser = datapath.ofproto_parser
    ...
    def __init__(self, flags=0, meter_id=ofproto.OFPM_ALL,
                 type_=None):
        super(OFPMeterConfigStatsRequest, self).__init__(flags)
        self.meter_id = meter_id
...
class OFPMeterConfigStatsReply(OFPMultipartReply):
    ...
    def __init__(self, type_=None, **kwargs):
        super(OFPMeterConfigStatsReply, self).__init__(**kwargs)
...
class OFPQueueGetConfigRequest(MsgBase):
    ...
    Example::
        ...
        def send_queue_get_config_request(self):
            ofp = datapath.ofproto
            ofp_parser = datapath.ofproto_parser
    ...
    """
    version = ofproto.OFP_VERSION
    msg_type = ofproto.OFPT_QUEUE_GET_CONFIG_REQUEST

    def __init__(self, port):
        super(OFPQueueGetConfigRequest, self).__init__(ofproto.OFP_VERSION, OFPQueueGetConfigRequest.msg_type)
        self.port = port
...
class OFPQueueProp(OFPQueuePropHeader):
    ...
    @staticmethod
    def register_property(property_: int, len_: Optional[int] = None) -> Callable:
...
class OFPQueueGetConfigReply(MsgBase):
    ...
    def __init__(self, queues=None, port=None):
        super(OFPQueueGetConfigReply, self).__init__(ofproto.OFP_VERSION, OFPQueueGetConfigReply.msg_type)
        self.queues = queues
        self.port = port

    @classmethod
    def parser(cls, msg_len: int, xid: int, buf: bytes) -> Callable:
        msg = super(OFPQueueGetConfigReply, cls).parser(msg_len, xid, buf)
...
class OFPRoleRequest(MsgBase):
    ...
    def __init__(self, role=None, generation_id=None):
...
class OFPRoleReply(MsgBase):
    ...
    @classmethod
    def parser(cls, msg_len: int, xid: int, buf: bytes) -> Callable:
        msg = super(OFPRoleReply, cls).parser(msg_len, xid,
                                              buf)
...
class OFPGetAsyncReply(MsgBase):
    ...
    def __init__(self, packet_in_mask=None, port_status_mask=None,
    ...
    @classmethod
    def parser(cls, msg_len: int, xid: int, buf: bytes) -> Callable:
        msg = super(OFPGetAsyncReply, cls).parser(msg_len,
                                                  xid, buf)
...
class ONFBundleCtrlMsg(OFPExperimenter):
    ...
    def __init__(self, bundle_id=None, type_=None, flags=None,
        ...
        super(ONFBundleCtrlMsg, self).__init__(
            ofproto_common.ONF_EXPERIMENTER_ID,
            ofproto.ONF_ET_BUNDLE_CONTROL)
...
nx_actions.generate(
    'fluxory.ofproto.ofproto_v1_3',
    'fluxory.ofproto.ofproto_v1_3_parser'
)
