...
from fluxory.ofproto.oxx_fields import (
...
from fluxory.lib.type_desc import IPv4Addr, IPv6Addr, IntDescr, MacAddr
...
class _OxmClass(object):
    def __init__(self, name: str, num: int, type_: Union[Type[IPv4Addr], Type[IPv6Addr], Type[MacAddr], IntDescr]) -> None:
        self.name = name
        self.oxm_field = num
...
class _Experimenter(_OxmClass):
    ...
    def __init__(self, name: str, num: int, type_: IntDescr) -> None:
